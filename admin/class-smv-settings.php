...
class SMV_Settings {
	 ...
	 * @var string
	 */
	const OPTION_GROUP = 'smv_settings_group';
	...
	private function __construct() {
		...
		add_action( 'update_option_smv_token_expiry', array( $this, 'flush_on_settings_change' ) );
	}
	...
	public function register_settings() {
		$settings = array(
			'smv_default_protection'   => array(
				'type'              => 'string',
				'sanitize_callback' => 'sanitize_text_field',
				'default'           => 'public',
			),
			'smv_token_expiry'          => array(
				'type'              => 'integer',
				'sanitize_callback' => 'absint',
				'default'           => 3600,
			),
			'smv_hotlink_protection'    => array(
				'type'              => 'boolean',
				'sanitize_callback' => array( $this, 'sanitize_bool' ),
				'default'           => true,
			),
			'smv_seo_noindex'           => array(
				'type'              => 'boolean',
				'sanitize_callback' => array( $this, 'sanitize_bool' ),
				'default'           => true,
			),
			'smv_disable_attachments'   => array(
				'type'              => 'boolean',
				'sanitize_callback' => array( $this, 'sanitize_bool' ),
				'default'           => true,
			),
			'smv_robots_txt'            => array(
				'type'              => 'boolean',
				'sanitize_callback' => array( $this, 'sanitize_bool' ),
				'default'           => false,
			),
			'smv_debug_mode'            => array(
				'type'              => 'boolean',
				'sanitize_callback' => array( $this, 'sanitize_bool' ),
				'default'           => false,
			),
			'smv_ip_validation'         => array(
				'type'              => 'boolean',
				'sanitize_callback' => array( $this, 'sanitize_bool' ),
				'default'           => false,
			),
			'smv_stream_large_files'    => array(
				'type'              => 'boolean',
				'sanitize_callback' => array( $this, 'sanitize_bool' ),
				'default'           => true,
			),
			'smv_stream_threshold'      => array(
				'type'              => 'integer',
				'sanitize_callback' => 'absint',
				'default'           => 10,
			),
			'smv_log_access'            => array(
				'type'              => 'boolean',
				'sanitize_callback' => array( $this, 'sanitize_bool' ),
				'default'           => true,
			),
			'smv_log_retention_days'    => array(
				'type'              => 'integer',
				'sanitize_callback' => 'absint',
				'default'           => 30,
			),
	...
	private function add_fields() {
		$fields = array(
			...
			array(
				'id'       => 'smv_ip_validation',
				'title'    => __( 'IP Validation', 'secure-media-vault' ),
				'callback' => array( $this, 'render_checkbox_field' ),
				'page'     => self::OPTION_GROUP,
				'section'  => 'smv_token',
				'args'     => array(
					'option'      => 'smv_ip_validation',
	...
	public static function render_page() {
		...
		include SMV_PLUGIN_DIR . 'admin/views/settings.php';
	}
	...
	public function render_default_protection() {
		$value   = get_option( 'smv_default_protection', 'public' );
		$options = array(
			'public'    => __( 'Public (WordPress default)', 'secure-media-vault' ),
			'logged_in' => __( 'Logged-in users only', 'secure-media-vault' ),
		);
		echo '<select name="smv_default_protection" id="smv_default_protection">';
